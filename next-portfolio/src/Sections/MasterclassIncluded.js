import IPHONE from '../../public/iPhoneCharts.png';
...
function MasterclassIncluded() {
  ...
  return (
    <div ref={layout} className="bg-zinc-800 pt-11 pb-11 lg:pt-20 lg:pb-20 lg:flex lg:flex-col lg:items-center">
      ...
      <div className="columns-2">
        <div className="ml-8 2xl:max-w-xs">
          <ul className="text-white mb-2">
            ...
            <li className="pb-8">
              <strong>In-depth text and video updates</strong> to keep you one
            ...
            <li className="pb-8">
              <strong>Monthly live events</strong> for a full breakdown of
        ...
        <div className="mr-8 2xl:max-w-xs">
          <ul className="text-white mb-2">
            ...
            <li className="pb-8">
              <strong>1-1 access to myself</strong> and an open line to ask any
              questions.{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <li className="pb-8">
              <strong>Active community</strong> to discuss ideas and make
      ...
      <Image src={IPHONE} alt="Masterclass iPhone" className="mx-auto sm:max-h-80"></Image>
      </div>
      </div>
      </FadeIn>
    </div>
...
export default MasterclassIncluded;
