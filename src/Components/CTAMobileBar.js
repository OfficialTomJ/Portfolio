...
function CTAMobileBar(props) {
    return(
        <div className="md:hidden fixed bottom-[-50px] w-full flex justify-center pb-2 pt-2 bg-zinc-800 transition-[bottom] ease-in-out" style={{ bottom: props.inView === true ? "-50px" : "0px"}}>
