...
import IMAC from '../../public/iMac Pro Mockup.png';
            ...
            <div className="lg:max-w-4xl 2xl:max-w-7xl">
                ...
                <div className=" lg:columns-1 md:flex md:items-center md:justify-center md:gap-8 lg:flex-col">
                    ...
                    <div className="ml-8 mr-8 mt-6 md:ml-0 md:mr-8 md:mt-0">
                        <Image src={IMAC} alt="Masterclass IMac" className="h-full w-full md:w-auto object-cover object-left bg-left md:max-h-96 md:object-contain md:object-center md:mr-8 lg:mr-0 lg:max-h-[32rem]"/>
                    </div>
            </div>
            </div>
            </FadeIn>
