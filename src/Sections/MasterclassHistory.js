...
import DeskImg from '../../public/desk-charts.jpg';
          ...
          <FadeIn visible={IsInView}>
            <div className="md:columns-2 md:flex md:items-center lg:max-w-4xl 2xl:max-w-7xl">
             <div className="break-after-column">
                ...
                <Image src={DeskImg} alt="deskImg" className="w-full md:pl-8 md:pr-8 md:hidden"/>
              ...
              <div className="flex h-full flex-col">
                <Image src={DeskImg} className="w-full md:pl-8 sm:pr-8 hidden md:block drop-shadow-md lg:pl-0 lg:pr-0" alt="deskImg"/>
