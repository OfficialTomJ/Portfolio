...
export default function Links() {
  ...
  return (
    <main className="bg-zinc-800 min-h-screen flex flex-col align-middle justify-center text-white pl-4 pr-4 lg:pl-0 lg:pr-0 pt-24">
      ...
      <LinkBox
        title="SUBSCRIBE TO CRYPTO CHRONICLES FREE NEWSLETTER 📬"
