        ...
        <div className="bg-zinc-800 pt-11 pb-11">
            <h2 className="text-white text-2xl ml-8 mr-8 pb-8"><strong>What is Masterclass Pro?</strong></h2>
                <div className="columns-2">
                    <div className="ml-8">
                    <ul className="list-disc text-white mb-6">
                        <li>Exclusive private group for quality analysis, updates and insights.</li>
                        <li>Foundation program to get you started with no prior knowledge.</li>
                        <li>Includes an active community to engage with and discuss ideas.</li>
                    </ul>
