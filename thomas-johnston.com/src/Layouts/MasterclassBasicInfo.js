    ...
    return(
        <div className="bg-zinc-800 lg:bg-[#1E1E1E] pt-11 pb-11 lg:pt-20 lg:pb-20 lg:flex lg:flex-col lg:items-center">
            <div className="lg:max-w-4xl 2xl:max-w-7xl">
                <h2 className="text-white text-2xl md:text-3xl lg:text-4xl ml-8 mr-8 pb-8 md:text-center md:text-3xl"><strong>What is Masterclass Pro?</strong></h2>
                <div className="columns-2 lg:columns-1 md:flex md:items-center md:justify-center md:gap-8 lg:flex-col">
                    <div className="ml-8 lg:ml-0 lg:max-w-3xl">
                    <div className="list-disc list-inside text-white mb-2 flex flex-col lg:flex-row lg:gap-12 lg:mb-8 lg:list-none lg:text-center ">
