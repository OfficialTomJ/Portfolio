...
function MasterclassDiscord() {
    return(
        <div className="bg-zinc-800 pb-11 pt-11">
            <h2 className="text-white text-2xl ml-8 mr-8 pb-8 text-center"><strong>A Community like No Other</strong></h2>
            
            <p className="text-white list-disc list-inside pl-8 pr-8 sm:pl-0 sm:pr-0 leading-relaxed text-center max-w-sm ml-auto mr-auto">
