        ...
        <div className="bg-zinc-800 pt-11" id="MasterclassHistory">
            <div className="md:columns-2 md:flex md:items-center">
             <div className="break-after-column">
                <h2 className="text-white text-2xl md:text-3xl md:leading-relaxed ml-8 mr-8 pb-8"><strong>Since 2015, </strong><br></br>I have been actively investing/trading crypto and mastering the skill set.</h2>
